...
find $TARGET/events/ -name '*.pb.go' -exec sed -i '' -e '/^func init() {/,/}/d' {} \;
find $TARGET/events/ -name '*.pb.go' -exec sed -i '' -e '1s|^|// init function auto-generated by protoc-gen-gogo auto-deleted by '$0$'\\\n\\\n|' {} \;
popd
